...
import cn.store.bean.Address;
import cn.store.mapper.AddressMapper;
import cn.store.service.IAddressService;
...
public class TestAddress {
	...
	public void updateAddress(){
		...
		address.setRecvAddress("�ж�����8��");
		address.setRecvPhone("10000139000");
		address.setRecvTag("��λ");
	...
	public void testInsertAddress(){
		...
		address.setRecvDistrict("�ӱ�ʡʯ��ׯ��XX��");
		address.setRecvAddress("�ж�����7��");
