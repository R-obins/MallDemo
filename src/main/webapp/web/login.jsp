    ...
    <div id="cover" class="rt">
        <form id="login-form" method="post" name="form1">
            <div class="txt">
                <p>
					登录学子商城<span>
					<a href="${pageContext.request.contextPath}/user/showRegister.do">
					新用户注册
					</a></span>
                </p>
                <div class="text">
                ...
                <div class="text">
                    ...
                    id="password" 
                    placeholder="请输入您的密码" 
                    name="lwd" required minlength="6" maxlength="15">
        ...
        $.ajax({
        	...
        	"success":function(obj){
        		...
        		if(obj.state==0){
        			...
        			//登录成功 ,设置cookie
        			Save();
        			window.location="${pageContext.request.contextPath}/main/showIndex.do";
        		}
        	}
