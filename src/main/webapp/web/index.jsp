...
<div class="lf1">
    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <c:forEach items="${computerList}" varStatus="status">
                <p>${computerList[status.index].name}</p>
                <ul>
                <c:forEach items="${category161List[status.index]}" var="computer">
      ...
      <c:forEach items="${goodsList}" var="goods">
        <div class="item_msg lf">
            <img  style="width: 198px;height: 136px" src="..${goods.image}" alt=""/>
