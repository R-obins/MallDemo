...
public class Address implements Serializable{
	...
	private static final long serialVersionUID = 1553737155770401546L;
	private Integer id;
	private Integer uid;
	...
	public String toString() {
		return "Address [id=" + id + ", uid=" + uid + ", recvName=" + recvName + ", recvProvince=" + recvProvince
				...
				+ recvZip + ", recvTag=" + recvTag + ", isDefault=" + isDefault + ", createUser=" + createdUser
